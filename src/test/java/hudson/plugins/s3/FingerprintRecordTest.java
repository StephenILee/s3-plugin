...
public class FingerprintRecordTest {
    ...
    public void testGetLinkFromWindowsPath() throws Exception {
        ...
        FingerprintRecord windowsRecord = new FingerprintRecord(true, "test", "https://storage.googleapis.com", windowsPath, "us-eat-1", "xxxx");
    ...
    public void testGetLinkFromUnixPath() throws Exception {
        ...
        FingerprintRecord unixRecord = new FingerprintRecord(true, "test", "https://storage.googleapis.com", unixPath, "us-eat-1", "xxxx");
