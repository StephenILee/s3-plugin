...
public final class S3DownloadCallable extends S3Callable<String>
{
    ...
    public S3DownloadCallable(String accessKey, Secret secretKey, boolean useRole, Destination dest, String region, String endPoint, ProxyConfiguration proxy)
    {
        super(accessKey, secretKey, useRole, region, endPoint, proxy);
        this.dest = dest;
    }
